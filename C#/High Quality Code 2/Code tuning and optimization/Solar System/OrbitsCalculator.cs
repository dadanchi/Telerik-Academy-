namespace SolarSystem
{
    ...
    public class OrbitsCalculator : INotifyPropertyChanged
    {
        ...
        private const double EarthOrbitRadiusValue = 40;
        private const double FullAngle = 360;
        ...
        {
            this.EarthRotationAngle = FullAngle * this.Days / EarthRotationPeriod;
        ...
        {
            this.SunRotationAngle = FullAngle * this.Days / SunRotationPeriod;
